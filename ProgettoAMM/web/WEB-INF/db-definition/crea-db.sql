...
CREATE TABLE oggetto(
    ...
    #
    FOREIGN KEY (cliente_id) REFERENCES cliente(id) ON UPDATE SET NULL,

    FOREIGN KEY (venditore_id) REFERENCES venditore(id) ON UPDATE SET NULL
);
...
INSERT INTO oggetto(id, nome, descrizione, urlImmagine, numeroPezzi, prezzo, venditore_id)
VALUES(default, 'Cutlas Red', 250, 5500000000, 2);
